import { SchoolGovernment } from "../domain/models/school-government/SchoolGovernment";
...
export const schoolGovermentShow: SchoolGovernment = { type          : tipo, 
    title         : titulo, 
    image         : `../../../../assets/gobierno-escolar/${ imagen_principal }`, 
    ...
    information_1 : { exist: existe_info_1_1, info  : texto_info_1_1, fontSize: tamano_info_1_1, link  : [{text: text_link_info_1_1_1, url: url_link_info_1_1_1}, {text: text_link_info_1_1_2, url: url_link_info_1_1_2}, {text: text_link_info_1_1_3, url: url_link_info_1_1_3}] }, 
    ...
    banner_1      : { a_link  : banner_link_1_1, exist  : banner_existe_1_1, urlLink : `../../../../../../assets/gobierno-escolar/${ banner_url_1_1 }`, isImg   : banner_es_imagen_1_1, }, 
    banner_2      : { a_link  : banner_link_2_1, exist  : banner_existe_2_1, urlLink : `../../../../../../assets/gobierno-escolar/${ banner_url_2_1 }`, isImg   : banner_es_imagen_2_1, }, 
    multimedia_1: { a_link  : multimedia_link_1_1, isImg   : multimedia_esImagen_1_1, exist  : multimedia_existe_1_1, urlLink :  `../../../../../../assets/gobierno-escolar/${ multimedia_url_1_1 }` }, 
    multimedia_2: { a_link  : multimedia_link_2_1, isImg   : multimedia_esImagen_2_1, exist  : multimedia_existe_2_1, urlLink :  `../../../../../../assets/gobierno-escolar/${ multimedia_url_2_1 }` } } 