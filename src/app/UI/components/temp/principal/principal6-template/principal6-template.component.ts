...
@Component({
  standalone: true,
  selector: 'app-principal6-template',
  templateUrl: './principal6-template.component.html',
  styleUrls: ['./principal6-template.component.css'],
  imports: [ CommonModule, MultimediaComponent, InformationComponent, BannersComponent ]
})
export class Principal6TemplateComponent {
