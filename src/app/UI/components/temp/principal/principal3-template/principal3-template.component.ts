...
@Component({
  standalone: true,
  selector: 'app-principal3-template',
  templateUrl: './principal3-template.component.html',
  styleUrls: ['./principal3-template.component.css'],
  imports: [ CommonModule, MultimediaComponent, InformationComponent, BannersComponent ]
})
export class Principal3TemplateComponent {
